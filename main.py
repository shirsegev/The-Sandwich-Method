...
openai.api_key = "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"
...
response = openai.Completion.create(engine="text-davinci-002", prompt=prompt, max_tokens=256, temperature=1, top_p=1,
